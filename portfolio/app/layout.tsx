...
const jsonLd = {
  ...
  "@graph": [
    // ── Person ────────────────────────────────────────────────────────
    {
      ...
      hasCredential: [
        { "@type": "EducationalOccupationalCredential", name: "Google Project Management Professional Certificate" },
        { "@type": "EducationalOccupationalCredential", name: "Google Digital Marketing & E-commerce Professional Certificate" },
      ],
      sameAs: [
    ...
    // ── ProfilePage (Google's recommended type for portfolio sites) ───
    {
      ...
      "@id": `${BASE}/#profilepage`,
      url: BASE,
      name: `${SITE_CONFIG.fullName} — Business Analyst Portfolio`,
      description: SITE_CONFIG.description,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${SITE_CONFIG.fullName} — Business Analyst`,
      },
    ],
  },
  robots: {
