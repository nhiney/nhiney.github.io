  ...
  projects: [
    {
      ...
      contributions: [
        "Khảo sát người dùng và wireframe trên Figma để xác định điểm vướng trong luồng đặt khám; nhận diện tương tác bằng giọng nói là nhu cầu khả năng tiếp cận then chốt cho người cao tuổi — từ đó quyết định xây dựng tính năng đặt khám bằng giọng nói.",
    ...
    },
    {
      ...
      contributions: [
        ...
        "Giảm tải bộ phận hỗ trợ khách hàng bằng cách tích hợp chatbot AI nhẹ để xử lý các câu hỏi phổ biến ở quy mô lớn.",
